package apple.discord.clover.database.web.auth;
...
import apple.discord.clover.database.web.auth.authentication.token.AuthTokenGenerator;
import apple.discord.clover.database.web.auth.authentication.token.DAuthToken;
import apple.discord.clover.database.web.auth.authentication.token.query.QDAuthToken;
import apple.discord.clover.database.web.auth.identity.DAuthIdentity;
import apple.discord.clover.database.web.auth.identity.DIdentityRoleBridge;
import apple.discord.clover.database.web.auth.identity.DUserBasicCredentials;
import apple.discord.clover.database.web.auth.identity.query.QDUserBasicCredentials;
import apple.discord.clover.database.web.auth.permission.DAuthPermission;
import apple.discord.clover.database.web.auth.permission.query.QDAuthPermission;
import apple.discord.clover.database.web.auth.role.DAuthRole;
import apple.discord.clover.database.web.auth.role.DRolePermissionBridge;
import apple.discord.clover.database.web.auth.role.query.QDAuthRole;
import apple.discord.clover.database.web.user.DUser;
import apple.discord.clover.database.web.user.DUserDiscord;
import apple.discord.clover.database.web.user.DUserMinecraft;
import io.ebean.DB;
...
public class AuthQuery {
    ...
    public static DAuthToken signup(SignupRequest request) {
        ...
        try (Transaction transaction = DB.beginTransaction()) {
            ...
            checkUniqueness(transaction, minecraft, discord, user, identity, credentials);
